...
exports.default = (0, vue_1.defineComponent)({
    ...
    setup(props) {
        ...
        const { scrollLeftRef, setListWidth } = (0, xScroll_1.setupXScroll)({
            ...
            renderCellRef: (0, vue_1.toRef)(props, 'renderCell')
        });
        const listElRef = (0, vue_1.ref)(null);
        const listHeightRef = (0, vue_1.ref)(undefined);
        const keyToHeightOffset = new Map();
        const itemsLengthRef = (0, vue_1.computed)(() => props.items.length);
        const finweckTreeRef = (0, vue_1.computed)(() => {
            ...
            if (itemAsKey) {
                ...
                const ft = new shared_1.FinweckTree(length, itemSize);
        ...
        function handleListWheel(e) {
            ...
            if (mayUseWheel) {
                ...
                if (listEl != null) {
                    ...
                    e.preventDefault();
                    if (e.shiftKey) {
                        listEl.scrollLeft += e.deltaY / (0, config_1.ensureWheelScale)();
                    }
                    else {
